...
#pragma warning restore CS0108 // Member hides inherited member; missing new keyword
        ...
        //
        public EnegyHistoryViewModel(INavigationService navigationService, IChartService chartService, IDialogService dialogService, IGetTime getTime, RestServices restServices) : base(navigationService)
        {
        ...
        public bool GetDataInDayAsync(int year, int month, int day, string timeUnit)
        {
            ...
            Xamarin.Forms.DependencyService.Get<IHealthServices>().FetchData(Configuration.CALORIES, async (datas) =>
            {
                ...
                foreach (ValueData valueData in Gets(datas))
                {
                    ...
                    var response = await RestServices.PostResponse(Configuration.APIENERGYS,
                        new
                        {
                            Time = valueData.Time,
