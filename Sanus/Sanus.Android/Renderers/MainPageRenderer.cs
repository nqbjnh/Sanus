...
namespace Sanus.Droid.Renderers
{
    internal class MainPageRenderer : VisualElementRenderer<MainPage>, IOnTabClickListener
    {
        ...
        private BottomBar CreateBottomBar(IEnumerable<Page> pageIntents)
        {
            ...
            bar.UseFixedMode();
            bar.SetFixedInactiveIconColor(Color.White); //unactive icon and text color
            PopulateBottomBarItems(bar, pageIntents);
            bar.ItemContainer.SetBackgroundColor(Android.Graphics.Color.ParseColor("#023e60"));
            bar.SetActiveTabColor(Android.Graphics.Color.ParseColor("#23b8f9"));//active icon and text color
        ...
        private void LoadCurrentPage()
        {
            ...
            else
            {
                ...
                var basePage = _currentPage as ContentPage;
